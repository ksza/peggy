 ...
 */
public class StatsSmsCountFetcher extends AsyncTask<Void, Void, Long> {

    private final String uuid;
    private final CardContainer container;

    public StatsSmsCountFetcher(final String uuid, final CardContainer container) {
        this.uuid = uuid;
    ...
    protected Long doInBackground(Void... params) {
        ...
        return ActivityLogEntry.countNoOfSmsToday();
    }

    @Override
    protected void onPostExecute(Long smsCountToday) {

        if(container != null) {
            container.smsCountFetched(uuid, smsCountToday);
        }
    }
}
