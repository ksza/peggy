...
public abstract class PhoneCallReceiver extends BroadcastReceiver {
    ...
    protected void onIncomingCallPickedUp(Context ctx, String number, Date start) {
    }
        ...
        switch (state) {
            ...
            case TelephonyManager.CALL_STATE_OFFHOOK:
                ...
                if(lastState == TelephonyManager.CALL_STATE_RINGING) {
                    final Date pickedUpTime = new Date();
                    onIncomingCallPickedUp(context, savedNumber, pickedUpTime);
