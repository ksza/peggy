 ...
 */
public class ActivityLogAddedEvent {

    private final ActivityLogEntry entry;

    public ActivityLogAddedEvent(final ActivityLogEntry entry) {
        this.entry = entry;
    }

    public ActivityLogEntry getEntry() {
        return entry;
    }
}
